...
export function Editor({ content, onChange }: EditorProps) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'prose prose-sm sm:prose lg:prose-lg xl:prose-2xl mx-auto focus:outline-none focus:border-purple-700 h-[280px] border-2 border-gray-200 p-4 rounded-bl-lg rounded-br-lg overflow-y-auto',
      },
    },
    content,
    onUpdate() {
